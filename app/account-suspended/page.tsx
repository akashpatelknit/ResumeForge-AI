    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-lg border bg-white p-8 text-center shadow-sm">
        ...
        <p className="mb-6 text-sm text-gray-600">
          Access to ResumeForge AI has been temporarily disabled for this account. If you believe this is a mistake,
          contact support at{" "}
          <a href="mailto:support@resumeforgeai.com" className="text-primary underline">
